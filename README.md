...
[![Go Report Card](https://goreportcard.com/badge/github.com/YOUR_USERNAME/YOUR_REPONAME)](https://goreportcard.com/report/github.com/ParulK-bhardwaj/makesite)
...
- [x] Add a new flag to your command named `file`. This flag represents the name of any `.txt` file in the same directory as your program. Run `./makesite --file=latest-post.txt` or `go run makesite.go --file=latest-post.txt` to test.
...
- [x] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
    ...
    - [x] **_FILL IN THE BLANK_**: `I will use the github.com/ttacon/chalk library. The documentation is located at https://github.com/ttacon/chalk. My goal is to use it to enhance the redability of terminal output and add some color.`
- [x] **Add, commit, and push to GitHub**.
